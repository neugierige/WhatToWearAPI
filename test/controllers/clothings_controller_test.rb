...
class ClothingsControllerTest < ActionController::TestCase
  ...
  test "should create clothing" do
    assert_difference('Clothing.count') do
      post :create, clothing: { brand: @clothing.brand, category: @clothing.category, color: @clothing.color, season: @clothing.season, style: @clothing.style, work_approp: @clothing.work_approp }
    end
  ...
  test "should update clothing" do
    patch :update, id: @clothing, clothing: { brand: @clothing.brand, category: @clothing.category, color: @clothing.color, season: @clothing.season, style: @clothing.style, work_approp: @clothing.work_approp }
    assert_redirected_to clothing_path(assigns(:clothing))
  end
